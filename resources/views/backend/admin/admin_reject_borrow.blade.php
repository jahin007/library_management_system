    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Rejected Books</h2>
                <div class="box-icon">
                    ...
                    @foreach($borrows as $borrow)
                        <tbody>
                            <tr>
                                ...
                                <td class="center" style="color: red;"><b>{{$borrow->status}}</b></td>
                                <td>
                                ...
                                <td class="center" style="color: red;">
                                    @if($borrow->status == 'Rejected')
                                        <h4>Book request has been rejected..</h4>
                                    @endif
                                </td>
                            </tr>
                        </tbody>
